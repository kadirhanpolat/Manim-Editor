<template>
  ...
  >
    ...
    <div v-if="!isCodeMode" class="p-3 border-b border-studio-border">
      ...
      <p
        class="text-[9px] mt-1.5 leading-relaxed"
        style="color: var(--studio-warning); opacity: 0.7"
      >
    ...
    <div v-if="isCodeMode" class="p-3 border-b border-studio-border">
      ...
      <p class="text-[10px] leading-relaxed" style="color: var(--studio-text-muted)">
        Upload images below. Click the <strong>copy path</strong> button to get a Manim-ready file
    ...
    <div class="p-3 border-b border-studio-border">
      <div class="flex items-center justify-between mb-2">
        ...
        <span
          ...
          class="text-[9px] text-studio-accent font-semibold bg-studio-accent/10 px-1.5 py-0.5 rounded-full"
          >{{ imageAssets.length }}</span
        >
      </div>
    ...
    <div class="p-3 border-b border-studio-border">
      <div class="flex items-center justify-between mb-2">
        ...
        <span
          v-if="svgAssets.length"
          class="text-[9px] font-semibold px-1.5 py-0.5 rounded-full"
          style="color: var(--studio-success); background: var(--studio-success-subtle)"
          >{{ svgAssets.length }}</span
        >
      </div>
    ...
    <div v-if="!isCodeMode" class="p-3 mt-auto border-t border-studio-border">
      ...
      <p
        v-if="!canTransform"
        class="text-[8px] text-studio-text-muted/40 text-center mt-1.5 leading-relaxed"
      >
...
const shapes = [
  {
    ...
    label: 'Rectangle',
    color: '#3b82f6',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="5" width="20" height="14" rx="2"/></svg>',
  },
  {
    type: 'square',
    label: 'Square',
    color: '#3b82f6',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><rect x="3" y="3" width="18" height="18" rx="3"/></svg>',
  },
  {
    type: 'circle',
    label: 'Circle',
    color: '#22c55e',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="12" cy="12" r="9"/></svg>',
  },
  {
    type: 'ellipse',
    label: 'Ellipse',
    color: '#06b6d4',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><ellipse cx="12" cy="12" rx="10" ry="6"/></svg>',
  },
  {
    type: 'triangle',
    label: 'Triangle',
    color: '#f59e0b',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polygon points="12 3 22 20 2 20"/></svg>',
  },
  {
    type: 'star',
    label: 'Star',
  ...
  },
  {
    ...
    label: 'Polygon',
    color: '#8b5cf6',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="12 2 22 8.5 22 15.5 12 22 2 15.5 2 8.5"/></svg>',
  },
  {
    type: 'polygon_free',
    label: 'Free Polygon',
    color: '#8b5cf6',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M7 4h10l3 8-8 8-8-8z"/></svg>',
  },
  {
    type: 'bezier',
    label: 'Bezier',
    color: '#f472b6',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 18 C 7 4, 17 4, 21 18"/><circle cx="3" cy="18" r="1.5" fill="currentColor" stroke="none"/><circle cx="21" cy="18" r="1.5" fill="currentColor" stroke="none"/></svg>',
  },
  {
    type: 'arrow',
    label: 'Arrow',
    color: '#ef4444',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>',
  },
  {
    type: 'heart',
    label: 'Heart',
  ...
  },
  {
    ...
    label: 'Line',
    color: '#94a3b8',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><line x1="4" y1="20" x2="20" y2="4"/></svg>',
  },
  {
    type: 'ray',
    label: 'Ray',
    color: '#22d3ee',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="5" cy="19" r="2.5" fill="currentColor" stroke="none"/><line x1="5" y1="19" x2="19" y2="5"/><polyline points="13 5 19 5 19 11"/></svg>',
  },
  {
    type: 'dot',
    label: 'Dot',
    color: '#94a3b8',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24"><circle cx="12" cy="12" r="5" fill="currentColor"/></svg>',
  },
  {
    type: 'dot_grid',
    label: 'Dot Grid',
    color: '#a855f7',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24"><circle cx="5" cy="5" r="2" fill="currentColor"/><circle cx="12" cy="5" r="2" fill="currentColor"/><circle cx="19" cy="5" r="2" fill="currentColor"/><circle cx="5" cy="12" r="2" fill="currentColor"/><circle cx="12" cy="12" r="2" fill="currentColor"/><circle cx="19" cy="12" r="2" fill="currentColor"/><circle cx="5" cy="19" r="2" fill="currentColor"/><circle cx="12" cy="19" r="2" fill="currentColor"/><circle cx="19" cy="19" r="2" fill="currentColor"/></svg>',
  },
  {
    type: 'latex',
    label: 'LaTeX',
    color: '#a855f7',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><text x="4" y="18" font-size="16" font-style="italic" fill="currentColor" stroke="none">fx</text></svg>',
  },
  {
    type: 'axes',
    label: 'Axes',
    color: '#10b981',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="3" y1="20" x2="3" y2="4"/><line x1="3" y1="20" x2="20" y2="20"/><polyline points="3 4 1 6 3 4 5 6"/><polyline points="20 20 18 18 20 20 18 22"/></svg>',
  },
  {
    type: 'annulus',
    label: 'Annulus',
    color: '#14b8a6',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="4"/></svg>',
  },
  {
    type: 'arc',
    label: 'Arc',
    color: '#f97316',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 12a9 9 0 0 1 18 0"/></svg>',
  },
  {
    type: 'sector',
    label: 'Sector',
    color: '#f59e0b',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 12 L12 3 A9 9 0 0 1 21 12 Z"/></svg>',
  },
  {
    type: 'double_arrow',
    label: 'Double Arrow',
    color: '#ef4444',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14M5 12l4-4M5 12l4 4M19 12l-4-4M19 12l-4 4"/></svg>',
  },
  {
    type: 'parametric',
    label: 'Parametric',
    color: '#10b981',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 18c4 0 4-12 8-12s4 12 8 12"/></svg>',
  },
  {
    type: 'matrix',
    label: 'Matrix',
    color: '#ffffff',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M7 4H5v16h2M17 4h2v16h-2"/><circle cx="10" cy="9" r="0.6" fill="currentColor"/><circle cx="14" cy="9" r="0.6" fill="currentColor"/><circle cx="10" cy="15" r="0.6" fill="currentColor"/><circle cx="14" cy="15" r="0.6" fill="currentColor"/></svg>',
  },
  {
    type: 'brace',
    label: 'Brace',
    color: '#ffffff',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 4c0 4-2 4-2 8s2 4 2 8M19 4c0 4 2 4 2 8s-2 4-2 8"/></svg>',
  },
  {
    type: 'angle',
    label: 'Angle',
...
const shapesData = [
  {
    ...
    label: 'Table',
    color: '#6366f1',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="5" width="20" height="14" rx="1"/><line x1="2" y1="10" x2="22" y2="10"/><line x1="8" y1="5" x2="8" y2="19"/><line x1="16" y1="5" x2="16" y2="19"/></svg>',
  },
  {
    type: 'numberplane',
    label: 'Number Plane',
    color: '#64748b',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><line x1="8" y1="3" x2="8" y2="21"/><line x1="16" y1="3" x2="16" y2="21"/><line x1="3" y1="8" x2="21" y2="8"/><line x1="3" y1="16" x2="21" y2="16"/></svg>',
  },
  {
    type: 'numberline',
    label: 'Number Line',
    color: '#10b981',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="2" y1="12" x2="22" y2="12"/><polyline points="18 8 22 12 18 16"/><line x1="6" y1="10" x2="6" y2="14"/><line x1="11" y1="10" x2="11" y2="14"/><line x1="16" y1="10" x2="16" y2="14"/></svg>',
  },
  {
    type: 'complex_plane',
    label: 'Complex Plane',
    color: '#22d3ee',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="3" x2="12" y2="21"/><line x1="3" y1="12" x2="21" y2="12"/><text x="13" y="8" font-size="7" fill="currentColor" stroke="none">i</text><text x="20" y="14" font-size="7" fill="currentColor" stroke="none">&#x211D;</text></svg>',
  },
  {
    type: 'polar_plane',
    label: 'Polar Plane',
    color: '#34d399',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="5"/><circle cx="12" cy="12" r="1"/><line x1="12" y1="3" x2="12" y2="21"/><line x1="3" y1="12" x2="21" y2="12"/></svg>',
  },
  {
    type: 'graph',
    label: 'Graph',
  ...
  },
  {
    ...
    label: 'Vector Comp',
    color: '#3b82f6',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="4" y1="20" x2="17" y2="7"/><polyline points="13 7 17 7 17 11"/><line x1="17" y1="7" x2="17" y2="20" stroke-dasharray="2 2"/><line x1="4" y1="20" x2="17" y2="20" stroke-dasharray="2 2"/></svg>',
  },
  {
    type: 'coord_point',
    label: 'Coord Point',
    color: '#fbbf24',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="8" cy="15" r="2.5" fill="currentColor" stroke="none"/><text x="11" y="11" font-size="8" fill="currentColor" stroke="none">x,y</text></svg>',
  },
  {
    type: 'counter',
    label: 'Counter',
...
const shapes3D = [
  {
    ...
    label: 'Sphere',
    color: '#e67700',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="9"/><ellipse cx="12" cy="12" rx="9" ry="4"/><line x1="3" y1="12" x2="21" y2="12"/></svg>',
  },
  {
    type: 'cube',
    label: 'Cube',
    color: '#3b5bdb',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 16V8a2 2 0 00-1-1.73l-7-4a2 2 0 00-2 0l-7 4A2 2 0 003 8v8a2 2 0 001 1.73l7 4a2 2 0 002 0l7-4A2 2 0 0021 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg>',
  },
  {
    type: 'prism',
    label: 'Prism',
    color: '#4263eb',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 15V9a1 1 0 00-.5-.87l-9-5.2a1 1 0 00-1 0l-9 5.2A1 1 0 002 9v6a1 1 0 00.5.87l9 5.2a1 1 0 001 0l9-5.2A1 1 0 0022 15z"/><polyline points="2.5 8.5 12 14 21.5 8.5"/><line x1="12" y1="22" x2="12" y2="14"/></svg>',
  },
  {
    type: 'cone',
    label: 'Cone',
    color: '#2f9e44',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2L3 20h18L12 2z"/><ellipse cx="12" cy="20" rx="9" ry="2"/></svg>',
  },
  {
    type: 'cylinder',
    label: 'Cylinder',
    color: '#1098ad',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5v14a9 3 0 0018 0V5"/></svg>',
  },
  {
    type: 'torus',
    label: 'Torus',
    color: '#9c36b5',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><ellipse cx="12" cy="12" rx="9" ry="4"/><ellipse cx="12" cy="12" rx="3" ry="1.5"/></svg>',
  },
  {
    type: 'axes3d',
    label: 'Axes 3D',
    color: '#868e96',
    icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="20" x2="12" y2="4"/><line x1="4" y1="20" x2="20" y2="20"/><line x1="12" y1="12" x2="4" y2="16"/></svg>',
  },
  {
    type: 'surface',
    label: 'Surface',
...
.shape-label {
  @apply text-[9px] text-studio-text-muted font-medium;
}
...
.asset-label {
  @apply block text-[9px] text-studio-text-muted truncate text-center mt-0.5;
}
.asset-remove {
