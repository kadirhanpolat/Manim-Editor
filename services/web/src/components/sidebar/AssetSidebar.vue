...
const shapes = [
  ...
  { type: 'polygon_free', label: 'Free Polygon', color: '#8b5cf6', icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M7 4h10l3 8-8 8-8-8z"/></svg>' },
  { type: 'bezier',       label: 'Bezier',       color: '#f472b6', icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 18 C 7 4, 17 4, 21 18"/><circle cx="3" cy="18" r="1.5" fill="currentColor" stroke="none"/><circle cx="21" cy="18" r="1.5" fill="currentColor" stroke="none"/></svg>' },
  ...
  { type: 'ray',       label: 'Ray',       color: '#22d3ee', icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="5" cy="19" r="2.5" fill="currentColor" stroke="none"/><line x1="5" y1="19" x2="19" y2="5"/><polyline points="13 5 19 5 19 11"/></svg>' },
...
const shapesData = [
  ...
  { type: 'numberplane',   label: 'Number Plane',  color: '#64748b', icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><line x1="8" y1="3" x2="8" y2="21"/><line x1="16" y1="3" x2="16" y2="21"/><line x1="3" y1="8" x2="21" y2="8"/><line x1="3" y1="16" x2="21" y2="16"/></svg>' },
  { type: 'numberline',    label: 'Number Line',   color: '#10b981', icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="2" y1="12" x2="22" y2="12"/><polyline points="18 8 22 12 18 16"/><line x1="6" y1="10" x2="6" y2="14"/><line x1="11" y1="10" x2="11" y2="14"/><line x1="16" y1="10" x2="16" y2="14"/></svg>' },
  ...
  { type: 'vector_components', label: 'Vector Comp', color: '#3b82f6', icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="4" y1="20" x2="17" y2="7"/><polyline points="13 7 17 7 17 11"/><line x1="17" y1="7" x2="17" y2="20" stroke-dasharray="2 2"/><line x1="4" y1="20" x2="17" y2="20" stroke-dasharray="2 2"/></svg>' },
  { type: 'coord_point', label: 'Coord Point', color: '#fbbf24', icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="8" cy="15" r="2.5" fill="currentColor" stroke="none"/><text x="11" y="11" font-size="8" fill="currentColor" stroke="none">x,y</text></svg>' },
  { type: 'counter',     label: 'Counter',      color: '#38bdf8', icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="6" width="18" height="12" rx="2"/><text x="6" y="16" font-size="9" font-family="monospace" fill="currentColor" stroke="none">42</text></svg>' },
];
...
const shapes3D = [
  ...
  { type: 'prism',    label: 'Prism',    color: '#4263eb', icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 15V9a1 1 0 00-.5-.87l-9-5.2a1 1 0 00-1 0l-9 5.2A1 1 0 002 9v6a1 1 0 00.5.87l9 5.2a1 1 0 001 0l9-5.2A1 1 0 0022 15z"/><polyline points="2.5 8.5 12 14 21.5 8.5"/><line x1="12" y1="22" x2="12" y2="14"/></svg>' },
