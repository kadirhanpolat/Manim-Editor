<template>
  ...
  <Section label="Add Motion">
    ...
    <div class="grid grid-cols-2 gap-1">
      ...
      <button class="anim-btn rotate" @click="anim('rotate')">
        <svg
          ...
          stroke-width="3"
        >
          <path d="M1 4v6h6M3.51 15a9 9 0 1014.85-3.36L23 8" />
        </svg>
        Rotate
      </button>
    </div>
    ...
    <div class="grid grid-cols-2 gap-1">
      <button data-test="anim-indicate" class="anim-btn emph" @click="anim('indicate')">
        Indicate
      </button>
      ...
      <button data-test="anim-circumscribe" class="anim-btn emph" @click="anim('circumscribe')">
        Circumscribe
      </button>
      <button data-test="anim-focus_on" class="anim-btn emph" @click="anim('focus_on')">
        Focus On
      </button>
    </div>
    <template v-if="obj.type === 'counter'">
      ...
      <div class="grid grid-cols-2 gap-1">
        <button
          data-test="anim-count"
          class="anim-btn move col-span-2"
