...
function circleCfg(obj) {
  ...
  return applyEffects(cfg, obj, e, r * 2, r * 2, true);
}
function ellipseCfg(obj) {
  ...
  return applyEffects(cfg, obj, e, rx * 2, ry * 2, true);
}
function dotCfg(obj) {
...
function heartCfg(obj) {
  ...
  return applyEffects(cfg, obj, e, w, h, true);
}
function triangleCfg(obj) {
  ...
  return applyEffects(cfg, obj, e, hw * 2, hh * 2, true);
}
function starCfg(obj) {
  ...
  return applyEffects(cfg, obj, e, outerRadius * 2, outerRadius * 2, true);
}
...
function lineCfg(obj) {
  ...
  return applyEffects(cfg, obj, e, hw * 2, 0, false);
}
